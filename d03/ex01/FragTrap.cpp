...
/*   Updated: 2018/01/10 23:43:33 by sjones           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::cout << ranged[(_rand % 10)] << " FR4G-TP " << this->_name << " attacks " << target << " at range, causing " << this->_ranged << " points of damage !" << std::endl;
return this->_ranged; };
...
"Take that!",
"Bop!"};
std::cout << melee[(_rand % 9)] << " FR4G-TP " << this->_name << " attacks " << target << " with melee, causing " << this->_melee << " points of damage !" << std::endl;
return this->_melee; };
...
std::cout << damage[(_rand % 13)] << " FR4G_TP " << this->_name << " got dealt " << amount <<  " damage reducing them to " << this->_hit << " hit points." << std::endl; };
...
std::cout << repair[(_rand % 5)] << " FR4G_TP " << this->_name << " was repaired " << amount <<  " putting their hit points at " << this->_hit << std::endl; }
...
if (this->_enrg > 25) {
	this->_enrg -= 25;
	std::cout << vlt_dot[(_rand % 25)] << " FR4G_TP deals " << (_rand % 20 + 10) <<  " random damage to " << target << std::endl;
	return (_rand % 20 + 10); }
else
...
"Oh well.", };
std::cout << goodbye[(_rand % 7)] << std::endl; };
